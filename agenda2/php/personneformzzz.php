...
<div name='idpers' style='border: 2px solid blue;'>
...
<!-- =================Nom famille==============================  -->
     ...
     "<input type='text' name='nomfam' id='nomfam' value=".$nomfam ."> <br>"; 
    ...
    //=================Initiales================================= 
     ...
     "<input type='text' name='init' id='init' value=".$init."> <br>"; 
          
    //=================Traitement================================= 
     "<label for='traitem'>Traitement: </label>";
     "<input type='text' name='traitem' id='traitem' value=".$traitem."> <br>"; 
