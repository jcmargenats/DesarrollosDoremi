...
<?php
  //========================================================================================
  // Function valpresonnealta Function pour valider avant de l'insert d'une nouveau personne
  //========================================================================================
  function valpersonnealta()
  {
    $imagesize = $_FILES['foto']['size'];
    $imagetype = $_FILES['foto']['type'];
    $auttype = array('image/jpg', 'image/jpeg', 'image/png');
    if(in_array($imagetype, $auttype)== false)
    {
      die("Type d'image pas permi");
      return false;
    }
    if($imagesize > 1000000)
    {
      echo $imagesize . "**";
      die("Image trop lourde" . $imagesize);
      return false;
    }
    return true;
  }
